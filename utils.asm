...
draw_cell:
    ; set up stack. Since we don't use ebp don't bother pushing it
    pushad
    ; mov ebp, esp
    ...
    ; BUT, use esp instead of ebp since we didn't set ebp properly.
...
draw_line:
    ...
    mov eax, [ds:esp+36]     ; load X coord into al, Y coord into ah
